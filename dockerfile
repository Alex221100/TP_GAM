...
RUN apt-get clean && apt-get update && apt-get install -y locales postgresql-client lsb-release
RUN echo 4 | dpkg -i /tmp/mysql-apt-config_0.8.15-1_all.deb
